...
public class Constants {
	...
	static {
		Messages.put(MessageTypes.ADMIN_ROLE_ADDED, "User promoted to admin successfully.");
		Messages.put(MessageTypes.ADMIN_ROLE_REMOVED, "Admin demoted to user successfully.");
		...
		Messages.put(MessageTypes.BOOK_ALREADY_IN_POSSESSION, "You are already borrowing this book. You can't reserve it.");
	}
}